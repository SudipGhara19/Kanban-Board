        ...
        <div className='w-full h-full max-w-screen-xl mx-auto py-5'>
            ...
            <div className='gsap-ani w-[70%] flex flex-col items-center p-4 mx-auto justify-center border-[1px] border-zinc-400 rounded-lg'>    <div className='flex flex-col items-center p-4'>
                ...
                <div className='w-[50%] flex justify-center gap-5'>
                    ...
                    <Link className='bg-transparent px-5 py-2 my-4 font-medium border-[1px] border-zinc-400 text-zinc-400 hover:text-zinc-200 hover:border-zinc-200 hover:scale-105 transition-all ease-in-out duration-300 rounded' to='https://github.com/SudipGhara19/Kanban-Board' >
                        Github Respository
                    </Link>
                </div>
            </div>
